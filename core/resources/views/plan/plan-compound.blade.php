...
@section('content')
    ...
    <div class="col-md-12" >
        <button id="btn-add" name="btn-add" style="margin-bottom: 20px;" class="btn btn-primary"><i class="fa fa-plus"></i> Add New Compound</button>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="frmTasks" name="frmTasks" class="form-horizontal" novalidate="">
                        ...
                        <div class="form-group error">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control has-error" id="name" name="name" placeholder="Compound Name" value="">
                        ...
                        <div class="form-group error">
                            ...
                            <div class="col-sm-9">
                                <div class="input-group mb15">
                                    <input type="text" class="form-control has-error" id="compound" name="compound" placeholder="Compound value" value="">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary" id="btn-save" value="add"><i class="fa fa-send"></i> Save Compound</button>
