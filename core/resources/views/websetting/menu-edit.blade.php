                ...
                <div class="panel-body">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input value="{{ $menu->name }}" type="text" name="name" id="" class="form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <textarea name="description" id="area1" cols="30" rows="10"
                                          class="form-control input-lg" required>{{ $menu->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-offset-3 col-md-8">
                                    <button type="submit" class="btn btn-blue btn-block margin-top-10" onclick="nicEditors.findEditor('area1').saveContent();"><i class="entypo-direction"></i> Update Menu</button>
                                </div>
                            </div>
                        </div>
                    </div>
